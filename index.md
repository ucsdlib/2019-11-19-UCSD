...
instructor: ["Andre Paloczy(SIO), Stephanie Labou (Library), Rick Mccosh (OB/GYN+Reprod. Sci.), Reid Otsuji (Library)", TBD] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Justin Schaefer", TBD]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
