...
instructor: ["Rick McCosh (OB/GYN+REPROD SCI), Reid Otsuji (Library)"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Ryan Johnson (Library), Eva Sanchez (Marine Biology), Anushka Rastogi (Library), Katherine Wang (Library)"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: http://pad.software-carpentry.org/2018-05-ucsdswc # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
